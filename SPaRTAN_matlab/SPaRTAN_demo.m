...
%  together with curated transcription factor (TF)-target interactions, 
...
%  TF-target interactions (D) by solving bilinear regression framework 
...
%  and the TF-target gene hit matrix (Y'DW).
%  This demo illustrates llustrates
...
%%Normalize data: D,Y, P were unit-normalized
